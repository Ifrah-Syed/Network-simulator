...
def client2():
	...
	if sen != PORT_ME:
		print("\n\n\n*************************************\nData Reached to Client2 from "+ received_data["sender_ip"])
		print("\nData:"+ received_data["data"])
		print("\n\n***************************************")
		rec = int(received_data["receiver_port"])
		if rec == PORT_ME:
			return "Received by Client2 Successfully"
		else:
			return "Message rejected by Client 2"
	else:
		return "Message sent from Client2"
