...
def client1():
	...
	if sen != PORT_ME:
		print("\n\n\n*************************************\nData Reached to Client3 from "+ received_data["sender_ip"])
		print("\nData:"+ received_data["data"])
		print("\n\n***************************************")
		rec = int(received_data["receiver_port"])
		if rec == PORT_ME:
		   return "Received by Client3 Successfully"
		else:
		   return  "Message rejected by Client 3"
	else:
	      return "Message sent from Client3"
